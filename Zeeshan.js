...
const login = require("api-social");
...
console.log(chalk.bold.hex("#00FF00").bold("[ ZEESHAN ] » ") + chalk.bold.hex("#00FF00").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/zeeshanqureshi0/ZeeshanBot008/main/listban.json').then(_0x2f978e => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(` Zeeshan Altaf`, '[ ZEESHAN ]');
        logger('Ap ka bht bht shukryia is bot ko use krny ka leya', '[ ZEESHAN ]');
        logger("Made By Zeeshan Altaf", '[ Zeeshan  Altaf]');
        logger("FB: https://www.facebook.com/zeeshanofficial01", 'Made By Zeeshan Altaf');
         ...
         setInterval(async function () {
             ...
             if (global.config.DeveloperMode == !![]) 
                 return logger(global.getText('mirai', 'refreshListen'), '[ ZESHAN ]');
         }, 600000);
    });
}
//////////////////////////////////////////////
...
console.log(chalk.bold.hex("#eff1f0").bold("================BOT OWNER ZEESHAN ALTAF=============="));
